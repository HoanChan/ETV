...
if __name__ == '__main__':
    ...
    cfg = {
        ...
        'structure_master_ckpt': f'/home2/nam/nam_data/work_dir/1114_TableMASTER_FinTabNet_seq500_cell150_batch4/epoch_{epoch_id}.pth',              # structure checkpoint file
        'structure_master_result_folder': f'/home2/nam/nam_data/work_dir/1114_TableMASTER_FinTabNet_seq500_cell150_batch4/structure_{val_test}_result_epoch_{epoch_id}',         # structure

        'test_folder': f'/disks/strg16-176/nam/data/fintabnet/img_tables/{val_test}/',                           # test image path
